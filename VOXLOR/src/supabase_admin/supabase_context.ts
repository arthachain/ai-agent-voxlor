...
export async function getSupabaseContext({
  ...
  // Edge functions and secrets are now included in the Supabase context
  // Edge functions can be deployed via: supabase functions deploy
  // Secrets can be managed via: supabase secrets set KEY=VALUE
